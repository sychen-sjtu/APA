...
def get_args():
    ...
    args.cfg = "/home/sychen/Projects/APA/APA/src/parking_slot_detection/scripts/gcn-parking-slot/config/ps_gat.yaml"
    args.ckpt = "/home/sychen/Projects/APA/APA/src/parking_slot_detection/scripts/gcn-parking-slot/model/checkpoint_epoch_200.pth"
    return args
